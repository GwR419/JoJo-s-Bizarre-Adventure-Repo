var styles = [ {
  ...
  "style" : [ {
    ...
    "selector" : "node[name = 'diavolo-emerges-part5']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'Jojos-part-5-ger-chapter-3']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'king-of-kings']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'Jojos-part-5-ger-chapter-4']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'Jojos-part-5-ger-chapter-1']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'diavolo_emerges_part1']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'Jojos-part-5-ger-chapter-2']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'diavolo_emerges_part2']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'diavolo-emerges-part3']",
    "css" : {
      "shape" : "v"
    }
  }, {
    "selector" : "node[name = 'diavolo-emerges-part4']",
    "css" : {
      "shape" : "v"
    }
  }, {
    ...
    "selector" : "node[currentWordCount > 1]",
    "css" : {
      "color" : "rgb(68,1,84)"
    }
  }, {
    ...
    "selector" : "node[currentWordCount > 0][currentWordCount < 1]",
    "css" : {
      "color" : "mapData(currentWordCount,0,1,rgb(33,145,140),rgb(68,2,86))"
    }
  }, {
    "selector" : "node[currentWordCount = 0]",
    "css" : {
    ...
    "selector" : "edge[BEND_MAP_ID > 30,817]",
    "css" : {
    ...
    "selector" : "edge[BEND_MAP_ID = 30,817]",
    "css" : {
      "line-color" : "rgb(189,0,38)"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID > 26,494][BEND_MAP_ID < 30,817]",
    "css" : {
      "line-color" : "mapData(BEND_MAP_ID,26,494,30,817,rgb(253,141,60),rgb(189,0,38))"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID > 22,172][BEND_MAP_ID < 26,494]",
    "css" : {
      "line-color" : "mapData(BEND_MAP_ID,22,172,26,494,rgb(255,237,160),rgb(253,141,60))"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID = 22,172]",
    "css" : {
    ...
    "selector" : "edge[BEND_MAP_ID > 30,817]",
    "css" : {
      "source-arrow-color" : "rgb(68,1,84)"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID = 30,817]",
    "css" : {
      "source-arrow-color" : "rgb(68,2,86)"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID > 26,494][BEND_MAP_ID < 30,817]",
    "css" : {
      "source-arrow-color" : "mapData(BEND_MAP_ID,26,494,30,817,rgb(33,145,140),rgb(68,2,86))"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID > 22,172][BEND_MAP_ID < 26,494]",
    "css" : {
      "source-arrow-color" : "mapData(BEND_MAP_ID,22,172,26,494,rgb(251,231,35),rgb(33,145,140))"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID = 22,172]",
    "css" : {
      "source-arrow-color" : "rgb(251,231,35)"
    }
  }, {
    "selector" : "edge[BEND_MAP_ID < 22,172]",
    "css" : {
      "source-arrow-color" : "rgb(253,231,37)"
    }
  }, {
    "selector" : "edge[currentWordCount > 83]",
    "css" : {
      "color" : "rgb(68,1,84)"
    }
  }, {
    ...
    "selector" : "edge[currentWordCount > 42][currentWordCount < 83]",
    "css" : {
      "color" : "mapData(currentWordCount,42,83,rgb(33,145,140),rgb(68,2,86))"
    }
  }, {
    "selector" : "edge[currentWordCount > 1][currentWordCount < 42]",
    "css" : {
      "color" : "mapData(currentWordCount,1,42,rgb(251,231,35),rgb(33,145,140))"
    }
  }, {
    "selector" : "edge[currentWordCount = 1]",
    "css" : {
